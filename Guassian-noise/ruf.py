...
cv.randn(gauss_noise,mean = random.randint(0,255), 
stddev=random.randint(0,50)) 
...
# calculate how similar are 'sums' and img2 - metric : eucledian d = howSimilar(img2,sums) 
# list of dist's 
distances.append(d) 
...
plt.plot(n_vals,distances,marker='o') 
